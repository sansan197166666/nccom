...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.66.53"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 54776;
pub const RELAY_PORT: i32 = 54777;
pub const WS_RENDEZVOUS_PORT: i32 =54778;
pub const WS_RELAY_PORT: i32 = 54779;
