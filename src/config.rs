...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.67.58"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 55776;
pub const RELAY_PORT: i32 = 55777;
pub const WS_RENDEZVOUS_PORT: i32 =55778;
pub const WS_RELAY_PORT: i32 = 55779;
